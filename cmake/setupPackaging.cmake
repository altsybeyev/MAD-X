...
if(APPLE)
    ...
    set(MACOSX_BUNDLE_ICON_FILE "${CMAKE_CURRENT_SOURCE_DIR}/cmake/MadX.icns")
    ...
    set(srcfiles ${srcfiles} ${CMAKE_CURRENT_SOURCE_DIR}/cmake/MadX.icns)
    set_source_files_properties(${CMAKE_CURRENT_SOURCE_DIR}/cmake/MadX.icns PROPERTIES MACOSX_PACKAGE_LOCATION Resources)
endif()
